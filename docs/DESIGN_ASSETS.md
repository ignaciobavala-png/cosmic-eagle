...
8. **Posible error de exportación**: `NOSOTROS/ASSETS/BANNER_HERO_NOSOTROS.png` y `VIAJES/ASSETS/IMAGE_VIAJES_PT2.png` son byte a byte el mismo archivo (md5 `ac7fd2fa…`). Preguntar a Julia si es intencional.
