# Bitácora de sesiones — Cosmic Eagle Journey

Historial cronológico de las sesiones de trabajo, movido acá el 2026-09-15 porque
`CLAUDE.md` había llegado a 170k caracteres (el tope de contexto son 150k) y se
cargaba entero en cada sesión.

**Cómo usarlo**: `CLAUDE.md` tiene el estado actual y las reglas que siguen
vigentes. Este archivo es el porqué: se consulta cuando hace falta saber **cómo
se llegó** a una decisión, no para arrancar a trabajar. Las sesiones nuevas se
agregan **acá**, al pie, no en `CLAUDE.md`.
...
poda, conservadas porque las sesiones de arriba las dan por contexto. **Están
superadas**: lo vigente es el `CLAUDE.md` de hoy.
