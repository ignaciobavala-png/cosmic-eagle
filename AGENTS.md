...
| Stack | Next.js 16.2.11 + React 19.2.4 + Supabase + Tailwind + Resend + Zustand + Framer Motion + TypeScript + Vercel |
| Estado | activo |
| Último commit | 2026-08-15 |
...
- `config-vacia-degrada-en-silencio` — **Config vacía que degrada en silencio — el string vacío interpolado en una URL**
  ...
  _citada por `panel-admin-fetch-sin-res-ok`_
