      ...
      <div className="px-5 max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-20 items-center">
          <div className="relative flex justify-center">
            ...
            <div className="relative glass-card aspect-[3/4] max-w-sm mx-auto rounded-xl p-8 border border-primary/30 flex flex-col items-center justify-center text-center shadow-2xl overflow-hidden">
              <span className="text-xs font-medium tracking-[0.05em] text-primary mb-4">
                COSMIC EAGLE
              </span>
              <h3 className="font-display text-[40px] md:text-[64px] md:leading-[72px] md:tracking-[-0.02em] leading-none text-white">
                TECNOLOGÍA HUMANA
              </h3>
              <div className="w-24 h-px bg-primary my-8" />
          ...
          <div>
            ...
            <h2 className="font-display text-[32px] md:text-[40px] md:leading-[48px] font-medium text-primary mb-6">
            ...
            <button className="mt-10 w-full sm:w-auto px-10 py-4 bg-primary text-on-primary text-sm font-semibold tracking-[0.1em] rounded-full shadow-lg hover:shadow-primary/20 transition-all duration-300">
              Comprar Ahora
            </button>
          </div>
        </div>
